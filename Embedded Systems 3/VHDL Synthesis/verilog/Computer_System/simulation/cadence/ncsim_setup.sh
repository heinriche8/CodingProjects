...
mkdir -p ./libraries/JTAG_to_FPGA_Bridge_master_limiter/
...
mkdir -p ./libraries/Nios2_custom_instruction_master_multi_slave_translator0/
mkdir -p ./libraries/Nios2_custom_instruction_master_multi_xconnect/
mkdir -p ./libraries/Nios2_custom_instruction_master_translator/
mkdir -p ./libraries/System_PLL/
mkdir -p ./libraries/Slider_Switches/
mkdir -p ./libraries/SDRAM/
mkdir -p ./libraries/Pushbuttons/
mkdir -p ./libraries/Nios2_Floating_Point/
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/Computer_System_Nios2_cpu_ociram_default_contents.dat ./
  cp -f $QSYS_SIMDIR/submodules/Computer_System_Nios2_cpu_ociram_default_contents.hex ./
  cp -f $QSYS_SIMDIR/submodules/Computer_System_Nios2_cpu_ociram_default_contents.mif ./
  cp -f $QSYS_SIMDIR/submodules/Computer_System_Nios2_cpu_rf_ram_a.dat ./
  cp -f $QSYS_SIMDIR/submodules/Computer_System_Nios2_cpu_rf_ram_a.hex ./
  cp -f $QSYS_SIMDIR/submodules/Computer_System_Nios2_cpu_rf_ram_a.mif ./
  cp -f $QSYS_SIMDIR/submodules/Computer_System_Nios2_cpu_rf_ram_b.dat ./
  cp -f $QSYS_SIMDIR/submodules/Computer_System_Nios2_cpu_rf_ram_b.hex ./
  cp -f $QSYS_SIMDIR/submodules/Computer_System_Nios2_cpu_rf_ram_b.mif ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Computer_System_mm_interconnect_0_avalon_st_adapter_002_error_adapter_0.sv" -work error_adapter_0                                         -cdslib ./cds_libs/error_adapter_0.cds.lib                                        
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Computer_System_mm_interconnect_0_avalon_st_adapter_002.vhd"                -work avalon_st_adapter_002                                   -cdslib ./cds_libs/avalon_st_adapter_002.cds.lib                                  
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Computer_System_mm_interconnect_0_avalon_st_adapter.vhd"                    -work avalon_st_adapter                                       -cdslib ./cds_libs/avalon_st_adapter.cds.lib                                      
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Computer_System_mm_interconnect_0_rsp_mux_001.sv"                           -work rsp_mux_001                                             -cdslib ./cds_libs/rsp_mux_001.cds.lib                                            
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Computer_System_mm_interconnect_0_cmd_demux_001.sv"                         -work cmd_demux_001                                           -cdslib ./cds_libs/cmd_demux_001.cds.lib                                          
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                                           -work JTAG_to_FPGA_Bridge_master_limiter                      -cdslib ./cds_libs/JTAG_to_FPGA_Bridge_master_limiter.cds.lib                     
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"                                            -work JTAG_to_FPGA_Bridge_master_limiter                      -cdslib ./cds_libs/JTAG_to_FPGA_Bridge_master_limiter.cds.lib                     
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                    -work JTAG_to_FPGA_Bridge_master_limiter                      -cdslib ./cds_libs/JTAG_to_FPGA_Bridge_master_limiter.cds.lib                     
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                           -work JTAG_to_FPGA_Bridge_master_limiter                      -cdslib ./cds_libs/JTAG_to_FPGA_Bridge_master_limiter.cds.lib                     
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Computer_System_mm_interconnect_0_router_001.sv"                            -work router_001                                              -cdslib ./cds_libs/router_001.cds.lib                                             
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_Nios2_cpu.v"                                                -work cpu                                                     -cdslib ./cds_libs/cpu.cds.lib                                                    
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_Nios2_cpu_debug_slave_sysclk.v"                             -work cpu                                                     -cdslib ./cds_libs/cpu.cds.lib                                                    
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_Nios2_cpu_debug_slave_tck.v"                                -work cpu                                                     -cdslib ./cds_libs/cpu.cds.lib                                                    
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_Nios2_cpu_debug_slave_wrapper.v"                            -work cpu                                                     -cdslib ./cds_libs/cpu.cds.lib                                                    
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_Nios2_cpu_test_bench.v"                                     -work cpu                                                     -cdslib ./cds_libs/cpu.cds.lib                                                    
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_customins_slave_translator.sv"                                       -work Nios2_custom_instruction_master_multi_slave_translator0 -cdslib ./cds_libs/Nios2_custom_instruction_master_multi_slave_translator0.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Computer_System_Nios2_custom_instruction_master_multi_xconnect.sv"          -work Nios2_custom_instruction_master_multi_xconnect          -cdslib ./cds_libs/Nios2_custom_instruction_master_multi_xconnect.cds.lib         
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_customins_master_translator.v"                                       -work Nios2_custom_instruction_master_translator              -cdslib ./cds_libs/Nios2_custom_instruction_master_translator.cds.lib             
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Computer_System_System_PLL.vhd"                                             -work System_PLL                                              -cdslib ./cds_libs/System_PLL.cds.lib                                             
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Computer_System_Slider_Switches.vhd"                                        -work Slider_Switches                                         -cdslib ./cds_libs/Slider_Switches.cds.lib                                        
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Computer_System_SDRAM.vhd"                                                  -work SDRAM                                                   -cdslib ./cds_libs/SDRAM.cds.lib                                                  
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Computer_System_SDRAM_test_component.vhd"                                   -work SDRAM                                                   -cdslib ./cds_libs/SDRAM.cds.lib                                                  
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Computer_System_Pushbuttons.vhd"                                            -work Pushbuttons                                             -cdslib ./cds_libs/Pushbuttons.cds.lib                                            
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/fpoint_wrapper.v"                                                           -work Nios2_Floating_Point                                    -cdslib ./cds_libs/Nios2_Floating_Point.cds.lib                                   
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/fpoint_qsys.v"                                                              -work Nios2_Floating_Point                                    -cdslib ./cds_libs/Nios2_Floating_Point.cds.lib                                   
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/fpoint_hw_qsys.v"                                                           -work Nios2_Floating_Point                                    -cdslib ./cds_libs/Nios2_Floating_Point.cds.lib                                   
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_Nios2.v"                                                    -work Nios2                                                   -cdslib ./cds_libs/Nios2.cds.lib                                                  
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Computer_System_LEDs.vhd"                                                   -work LEDs                                                    -cdslib ./cds_libs/LEDs.cds.lib                                                   
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Computer_System_JTAG_to_FPGA_Bridge.vhd"                                    -work JTAG_to_FPGA_Bridge                                     -cdslib ./cds_libs/JTAG_to_FPGA_Bridge.cds.lib                                    
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Computer_System_JTAG_UART.vhd"                                              -work JTAG_UART                                               -cdslib ./cds_libs/JTAG_UART.cds.lib                                              
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Computer_System_Interval_Timer.vhd"                                         -work Interval_Timer                                          -cdslib ./cds_libs/Interval_Timer.cds.lib                                         
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Computer_System_HEX5_HEX4.vhd"                                              -work HEX5_HEX4                                               -cdslib ./cds_libs/HEX5_HEX4.cds.lib                                              
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/submodules/Computer_System_HEX3_HEX0.vhd"                                              -work HEX3_HEX0                                               -cdslib ./cds_libs/HEX3_HEX0.cds.lib                                              
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/Computer_System.vhd"                                                                                                                                                                                                                   
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/computer_system_rst_controller.vhd"                                                                                                                                                                                                    
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/computer_system_rst_controller_001.vhd"                                                                                                                                                                                                
fi
